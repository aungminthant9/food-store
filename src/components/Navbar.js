...
const Navbar = () => {
    ...
    return (  
        <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
            ...
            {/* Cart */}
            <button className='hidden md:flex items-center bg-black text-white rounded-full py-2'>
        ...
        {nav?  <div className='bg-black/80 fixed w-full h-screen z-10 top-0'>
            ...
            {/* side drawer menu */}
            <div className={nav? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300 ease-in-out':'fixed left-[-100%] ease-in-out duration-500'}>
